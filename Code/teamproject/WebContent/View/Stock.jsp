<%@page import="teamproject.Stock_DBManager"%>
<%@page import="teamproject.Stock"%>
...
<%
Stock_DBManager stdm = new Stock_DBManager();
ArrayList<Stock> list = stdm.select();
%>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="row" id="allsto_result">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								<h6 class="card-title">
								<%out.println(stu.getSt_code() + ")");%>
								<%out.println(stu.getPd_code());%>
								</h6>
								</a>
								<p class="card-text">
